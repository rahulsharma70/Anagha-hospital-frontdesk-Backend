"""
Configuration file for server settings (shared with mobile project)
...
# Web project always uses port 3000 (mobile project uses 8000)
# Use WEB_PORT env var if set, otherwise default to 3000
SERVER_PORT = int(os.getenv("WEB_PORT", "3000"))  # Web project uses port 3000
...
# JWT Configuration (shared with mobile project)
JWT_SECRET = os.getenv("JWT_SECRET", "anagha-hospital-solutions-secret-key-2024")
JWT_ALGORITHM = "HS256"
JWT_EXPIRATION_HOURS = 24

# Supabase client (shared with mobile project)
supabase = None
